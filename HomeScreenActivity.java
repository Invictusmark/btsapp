...
//        loadingPB.setVisibility(View.VISIBLE);
        ...
        for (int i = 0; i < 10; i++) {
            wallpaperArrayList.add(String.valueOf(getResources().getIdentifier("wall_" + (i + 1), "drawable", getPackageName())));
        }
...
//        queue.add(jsonObjectRequest);
    ...
    private void getCategories() {
        ...
        categoryRVModals.add(new CategoryRVModal("Latest BTS", "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTJ8fHRlY2hub2xvZ3l8ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60"));
